...
LABEL_PROJECTION_MAP = {
    ...
    # 11: {'color': (125, 100, 25), 'label': 11},
    # 12: {'color': (128, 255, 0), 'label': 12},
    # 13: {'color': (0, 255, 128), 'label': 13},
    # 15: {'color': (204, 0, 0), 'label': 14},
    # 16: {'color': (0, 255, 234), 'label': 15},
    # 17: {'color': (255, 128, 128), 'label': 16},
    # 18: {'color': (60, 75, 255), 'label': 17},
    # 24: {'color': (255, 255, 128), 'label': 18},
    # 25: {'color': (0, 204, 128), 'label': 19},
    # 26: {'color': (255, 255, 255), 'label': 20},
    # 27: {'color': (162, 232, 108), 'label': 21},
    # 28: {'color': (153, 0, 153), 'label': 22},
    # 29: {'color': (153, 76, 0), 'label': 23},
}